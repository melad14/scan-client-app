...
class _RegisterScreenState extends State<RegisterScreen> with SingleTickerProviderStateMixin {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('6 أحرف على الأقل', style: TextStyle(fontSize: 11, color: AppColors.textMuted)),
                        const SizedBox(height: 16),
                        ...
                        // ─── Register Button ──────────────────────
                        _GradientButton(label: 'إنشاء الحساب والدخول', isLoading: _isLoading, onTap: _handleRegister),
                        const SizedBox(height: 20),
  ...
  Widget _buildField(String label, IconData icon, TextEditingController ctrl,
      {String? hint, bool ltr = false, TextInputType? keyboardType}) {
    return Column(
